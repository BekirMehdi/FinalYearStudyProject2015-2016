...
class UtilisateursController extends Controller
{
       ...
       public function confirmedAction()
    {
        ...
        return $this->render('UtilisateursBundle:Default:modulesUsed/utilisateursConnecte1.html.twig', array(
            'user' => $user,
        ));
    }
    ...
    public function aidePDFAction()
    { 
        $this->container->get('setNewAide')->aide()->Output('Aide.pdf');
