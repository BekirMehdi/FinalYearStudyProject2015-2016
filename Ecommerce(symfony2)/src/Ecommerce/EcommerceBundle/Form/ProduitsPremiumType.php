...
class ProduitsPremiumType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Ecommerce\EcommerceBundle\Entity\ProduitsPremium'
        ));
    }
    ...
    {
        return 'ecommerce_ecommercebundle_ProduitsPremium';
    }
}
