...
class SuperBoutiquesType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('lng','text', array('required' => false,'label' => false,
                                                'attr' => array('class' => 'ecommerce_ecommercebundle_boutiqueslng')))
            ->add('atitud','text', array('required' => false,'label' => false,
                                                'attr' => array('class' => 'ecommerce_ecommercebundle_boutiques_atitud')))
        ;
    }
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Ecommerce\EcommerceBundle\Entity\Boutiques'
        ));
    }
    ...
    {
        return 'ecommerce_ecommercebundle_boutiques';
    }
}
