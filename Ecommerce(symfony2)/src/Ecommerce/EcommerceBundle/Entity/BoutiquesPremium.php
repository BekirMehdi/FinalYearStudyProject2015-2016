 ...
 * BoutiquesPremium
 *
 * @ORM\Table("BoutiquesPremium")
 * @ORM\Entity(repositoryClass="Ecommerce\EcommerceBundle\Repository\BoutiquesPremiumRepository")
 */
class BoutiquesPremium
{
    /**
     * @var integer
     *
    ...
    private $categorie;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="Utilisateurs\UtilisateursBundle\Entity\Utilisateurs", inversedBy="boutiquesPremium")
