...
class Utilisateurs extends \Utilisateurs\UtilisateursBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'commandes', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'boutiques', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'adresses', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'Telephone', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'Adresse', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'Code_postal', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addBoutique(\Ecommerce\EcommerceBundle\Entity\Boutiques $boutiques)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBoutique', array($boutiques));

        return parent::addBoutique($boutiques);
    }
    ...
    public function removeBoutique(\Ecommerce\EcommerceBundle\Entity\Boutiques $boutiques)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBoutique', array($boutiques));

        return parent::removeBoutique($boutiques);
    }
    ...
    public function getBoutiques()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBoutiques', array());
