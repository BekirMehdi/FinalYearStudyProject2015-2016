 ...
 */
class ContactUs extends \Ecommerce\EcommerceBundle\Entity\ContactUs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\ContactUs' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\ContactUs' . "\0" . 'firstName', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\ContactUs' . "\0" . 'email', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\ContactUs' . "\0" . 'compagnie', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\ContactUs' . "\0" . 'telephone', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\ContactUs' . "\0" . 'adresse', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\ContactUs' . "\0" . 'commentaire');
        }
