 ...
 */
class MediaArticles extends \Pages\PagesBundle\Entity\MediaArticles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pages\\PagesBundle\\Entity\\MediaArticles' . "\0" . 'id', '' . "\0" . 'Pages\\PagesBundle\\Entity\\MediaArticles' . "\0" . 'updateAt', '' . "\0" . 'Pages\\PagesBundle\\Entity\\MediaArticles' . "\0" . 'nom_image', '' . "\0" . 'Pages\\PagesBundle\\Entity\\MediaArticles' . "\0" . 'path', 'fichier');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MediaArticles $proxy) {
    ...
    public function getNomImage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomImage', array());
    ...
    public function setNomImage($nomImage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomImage', array($nomImage));
