 ...
 */
class BoutiquesPremium extends \Ecommerce\EcommerceBundle\Entity\BoutiquesPremium implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'id', 'image', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'categorie', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'utilisateur', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'nom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'fb', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'twi', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'goog', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'yout', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'description', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'telephone', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'adresseEmail', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'adresse', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'date_creation', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'lng', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\BoutiquesPremium' . "\0" . 'atitud');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BoutiquesPremium $proxy) {
