 ...
 */
class Commentaires extends \Pages\PagesBundle\Entity\Commentaires implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pages\\PagesBundle\\Entity\\Commentaires' . "\0" . 'id', '' . "\0" . 'Pages\\PagesBundle\\Entity\\Commentaires' . "\0" . 'date_creation', '' . "\0" . 'Pages\\PagesBundle\\Entity\\Commentaires' . "\0" . 'id_article', '' . "\0" . 'Pages\\PagesBundle\\Entity\\Commentaires' . "\0" . 'nom', '' . "\0" . 'Pages\\PagesBundle\\Entity\\Commentaires' . "\0" . 'email', '' . "\0" . 'Pages\\PagesBundle\\Entity\\Commentaires' . "\0" . 'commentaire');
        }
